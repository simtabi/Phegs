...
trait PasswordValidatorsTrait
{
    ...
    public function isUsablePassword($value, $minLength = 6, $maxLength = 150) {
    ...
    public function isValidPasswordScore($value, $minimumScore = 3) {
