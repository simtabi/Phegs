...
trait DateTimeToolsTrait
{
     ...
     * @return array
     */
    public function indexedDatesInArray($from, $to, $step = '+1 day', $outputFormat = 'Y-m-d'): array
    {
        $dates   = [];
     ...
     * @return array
     */
    public function associativeDatesInArray($from, $to, $default = null, $step = '+1 day', $outputFormat = 'Y-m-d'): array
    {
