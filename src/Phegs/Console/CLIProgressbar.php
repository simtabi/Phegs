...
class CLIProgressbar
{
    ...
    public const NEW_LINE_CHARACTER            = "\n";
    public const NEW_LINE_CHARACTER_PHP_EOL    = PHP_EOL;
    ...
    /**
     * Instance of CLIRegistry. Used to store metrics.
     */
     ...
     * Class constructor
     */
    public function __construct($current, $max, $width = 80, $doneBarElementCharacter = self::PROGRESS_COMPLETE_CHARACTER, $remainingBarElementCharacter = self::PROGRESS_INCOMPLETE_CHARACTER, $currentPositionCharacter = '>')
    {
     ...
     * Sets a CLIRegistry
     *
     * @param CLIRegistry $registry
     */
    public function setRegistry(CLIRegistry $registry)
    {
        $this->registry = $registry;
    }

    /**
     * Returns the CLIRegistry
     *
     * @return static
     */
    ...
    protected function registerDefaultReplacementRules()
    {
        ...
        $this->addReplacementRule('%eta%', 40, function ($buffer, $registry)
        {
            ...
            if (count($advancement) == 1)
                return $this->painter->yellow('Calculating...');
    ...
    protected function display($lineReturn)
    {
        ...
        $eolCharacter = ($lineReturn) ? self::NEW_LINE_CHARACTER_PHP_EOL : self::CARRIAGE_RETURN_CHARACTER;
