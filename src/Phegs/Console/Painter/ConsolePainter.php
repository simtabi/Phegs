...
namespace Simtabi\Pheg\Phegs\Console\Painter;
...
class ConsolePainter implements ConsoleArtistGuild, ANSIColors
{
    ...
    protected function applyFormat(string $apply, ?string $undo, ?string $text = null): static
    {
        $this->applied[] = $apply;
        if ($undo !== null) {
