...
namespace Simtabi\Pheg\Facets\Multimedia\Multimedia\Player;
...
class Player {
     ...
     *	@var callable
     */
    protected $_template = 'Player\Player::template';
    /**
...
HTML;
    ...
    public function html($source, array $params = [], callable $template = null) {
        ...
        if ($id) {
            ...
            $source = call_user_func($template ? $template : $this->_template, $url);
        }
        return $source;
    }
    /**
