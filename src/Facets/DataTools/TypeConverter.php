...
namespace Simtabi\Pheg\Phegs\Helpers\DataTools;
...
class TypeConverter {
     ...
     * @return array
     */
    public static function fromAnyToArray($data, $associative = false){
        $data = self::toArray(json_decode(json_encode($data, JSON_FORCE_OBJECT), $associative));
     ...
     * @return object
     */
    public static function fromAnyToObject($data, $associative = false){
        $data = self::toObject(json_decode(json_encode($data, JSON_FORCE_OBJECT), $associative));
