...
trait PhoneToolsTrait
{
     ...
     * @return string
     */
    public static function e164($number, $defaultRegion = null) {
        $defaultRegion = Validators::isEmpty($defaultRegion) ? self::getDefaultRegion() : $defaultRegion;
     ...
     * @return string
     */
    public static function national($number, $defaultRegion = null) {
        $defaultRegion = Validators::isEmpty($defaultRegion) ? self::getDefaultRegion() : $defaultRegion;
        $proto         = self::getNumberProto($number, $defaultRegion);
        $util          = PhoneNumberUtil::getInstance();
     ...
     * @return string
     */
    public static function international($number, $defaultRegion = null) {
        $defaultRegion = Validators::isEmpty($defaultRegion) ? self::getDefaultRegion() : $defaultRegion;
        $proto         = self::getNumberProto($number, $defaultRegion);
        $util          = PhoneNumberUtil::getInstance();
     ...
     * @return string
     */
    public static function localized($number, $defaultRegion) {
        $defaultRegion = Validators::isEmpty($defaultRegion) ? self::getDefaultRegion() : $defaultRegion;
        $proto         = self::getNumberProto($number, $defaultRegion);
        $util          = PhoneNumberUtil::getInstance();
